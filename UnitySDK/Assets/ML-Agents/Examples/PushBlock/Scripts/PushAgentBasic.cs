...
public class PushAgentBasic : Agent
{
    ...
    private PushBlockAcademy academy;
    ...
    private Rigidbody blockRB;  //cached on initialization
    private Rigidbody agentRB;  //cached on initialization
    private Material groundMaterial; //cached on Awake()
